...
URL = "https://github.com/andlo/ovos-skill-math-practice"
SKILL_CLAZZ = "MathPractice"
PYPI_NAME = "ovos-skill-math-practice"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Math practice for OVOS - counting, times tables, and arithmetic quizzes across add/subtract/multiply/divide, fully offline",
    ...
    keywords="ovos skill voice assistant math education times tables quiz kids",
